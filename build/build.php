...
try {
    ...
    $poffConfigCoreHelpers = str_replace(['<?php', '?>'], '', $poffConfigCoreHelpers);
    $poffConfigLayoutFiles = str_replace(['<?php', '?>'], '', $poffConfigLayoutFiles);
    $poffConfigLayoutView = str_replace(['<?php', '?>'], '', $poffConfigLayoutView);
    $poffConfigLayoutCollections = str_replace(['<?php', '?>'], '', $poffConfigLayoutCollections);
    $poffConfigLayoutPersistence = str_replace(['<?php', '?>'], '', $poffConfigLayoutPersistence);
    $poffConfigLayoutPersistence = preg_replace('/^\s*require_once[^\n]*\n/m', '', $poffConfigLayoutPersistence);
    $poffConfigPromptHelpers = str_replace(['<?php', '?>'], '', $poffConfigPromptHelpers);
