...
.border-slate-600{--un-border-opacity:1;border-color:rgb(71 85 105 / var(--un-border-opacity));}
...
.bg-cyan-400{--un-bg-opacity:1;background-color:rgb(34 211 238 / var(--un-bg-opacity));}
...
.to-slate-200{--un-gradient-to-position:100%;--un-gradient-to:rgb(226 232 240 / var(--un-to-opacity, 1)) var(--un-gradient-to-position);}
.to-slate-50{--un-gradient-to-position:100%;--un-gradient-to:rgb(248 250 252 / var(--un-to-opacity, 1)) var(--un-gradient-to-position);}
...
.outline-blue-600\/15{outline-color:rgb(37 99 235 / 0.15);}
