...
.edit-drawer .prompt-window {
  display: grid;
  gap: 10px;
  margin-top: 10px;
}

.edit-drawer .prompt-messages {
  border: 1px solid #e5e7eb;
  border-radius: 8px;
  padding: 10px;
  background: #f8fafc;
...
.edit-drawer .prompt-message {
  margin: 0 0 8px;
}

.edit-drawer .prompt-message .role {
  font-weight: 600;
  margin-right: 6px;
}

.edit-drawer .prompt-actions {
  display: flex;
  gap: 8px;
  align-items: center;
}
